...
export default function AmenitiesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col gap-16 min-h-[85vh]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {allAmenities.map((amenity, idx) => (
          <motion.div
            ...
            className="p-8 rounded-3xl bg-card border border-primary/10 shadow-md hover:border-primary/30 transition-all duration-300 group hover:shadow-xl hover:-translate-y-1 flex flex-col gap-5"
          >
            <div className="w-12 h-12 rounded-2xl gold-gradient text-background flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform duration-300">
              {amenity.icon}
            </div>
      ...
      <div className="p-8 md:p-12 rounded-3xl bg-primary/5 border border-primary/10 text-center flex flex-col items-center gap-6 max-w-4xl mx-auto w-full mt-8">
        <h3 className="text-2xl font-serif font-bold text-foreground">Have a Specific Request?</h3>
